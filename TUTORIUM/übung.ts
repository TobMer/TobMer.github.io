...
let suffix: string[] = [" des Verderbens", " aus der Hölle", " der Lethalität", " mit Rheuma", " der Redundanz", " der Zerberstung", " der Arethmie", " der Fäulnis", " der Endzeit", " der Berlinkommende", " aus dem Häusschen"]; // length = 6, da hier 6 Einträge sind. Von 0-5.
